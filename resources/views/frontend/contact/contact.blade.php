                ...
                <div class="contact-form-area">
                    <form action="{{route('contact_post')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <span class="input">
                                    <input class="input_field" name="first_name" type="text" id="input-1">
                            ...
                            <div class="col-sm-6">
                                <span class="input">
                                        <input class="input_field" name="last_name" type="text" id="input-2">
                            ...
                            <div class="col-sm-6">
                                <span class="input">
                                        <input class="input_field" name="subject" type="text" id="input-4">
                            ...
                            <div class="col-sm-12">
                                <span class="input">
                                        <textarea class="input_field" name="message"  id="message"></textarea>
